...
pub fn list_image_tag_groups(db: State<BkDb>) -> Result<tag_manager::TagManagerData, AppError> {
    ...
    tag_manager::load_manager_data(&conn, TagDomain::Image).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn create_image_tag_group(
    ...
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::create_group(&conn, TagDomain::Image, &name, sort_order).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn update_image_tag_group(
    ...
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::update_group(&conn, TagDomain::Image, id, &name, sort_order).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn delete_image_tag_group(db: State<BkDb>, id: i64) -> Result<(), AppError> {
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::delete_group(&conn, TagDomain::Image, id).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn create_image_tag(
    ...
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::create_tag(&conn, TagDomain::Image, &name, group_id).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn rename_image_tag(db: State<BkDb>, id: i64, name: String) -> Result<(), AppError> {
    ...
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::rename_tag(&conn, TagDomain::Image, id, &name).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn delete_image_tag(db: State<BkDb>, id: i64) -> Result<(), AppError> {
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::delete_tag(&conn, TagDomain::Image, id).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn move_tag_to_group(db: State<BkDb>, id: i64, group_id: Option<i64>) -> Result<(), AppError> {
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::move_tag(&conn, TagDomain::Image, id, group_id).map_err(|e| AppError::Message(e.to_string()))
}
...
pub fn pin_image_tag_group_to_top(db: State<BkDb>, id: i64) -> Result<(), AppError> {
    let conn = db.0.lock().map_err(|e| AppError::Message(e.to_string()))?;
    tag_manager::pin_group_to_top(&conn, TagDomain::Image, id).map_err(|e| AppError::Message(e.to_string()))
}